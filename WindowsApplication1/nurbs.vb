...
Public Class Nurbs
    ...
    Public Function CraterFunction(ByVal u As Double)
        ...
        'Warp.DrawBasis()
        Output = Warp.BasisFunctions(u)(3) / Warp.BasisFunctions(1 / 2)(3)
        Return Output
    End Function
    ...
    'Public Function MinDistance(ByVal a As Nurbs)
    ...
    '            If Distance(a, u, v) < Distance(a, min(0), min(1)) Then
    ...
    Public Property PNurbsDistance()
        ...
        End Set
    End Property
    'Find the span of a value of a parameter
    ...
    'Basis Functions
    'This function outputs a one-dimensional array of length p+1
    'This array N outputs the non-zero basis functions evaluated at u divided by the sum of the weights
